    ...
    return (
        <div className="bg-white  mx-auto w-[85%]">
            ...
            <div className="animate-skills-section relative w-[100%] md:w-[70%] text-center mx-auto my-8">
                ...
                {skills.map((skill) => {
                    return (
                        <div className="delay-75 flex hover:bg-darkblue hover:text-darkblueTwo justify-around items-center w-[auto] px-[5px] border border-darkblueThree text-darkblue m-2 rounded-lg">
