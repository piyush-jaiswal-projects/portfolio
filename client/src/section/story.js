import { Heading, TextPara } from "../components"

export default function Story(props) {
    return (
        <div className="bg-darkblue w-[90vw] text-[3.5vw] sm:text-[3vw] md:text-[2.3vw] lg:text-[1.3vw] mx-auto my-5">
            <Heading text="A deep dive into my story" />
