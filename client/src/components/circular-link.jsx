export default function CircularLink(props) {
    const divClass = `cursor-pointer hover:animate-spin inline-flex items-center justify-center rounded-full w-[12.5vw] sm:w-[10vw] md:w-[6vw] lg:w-[3.5vw] h-[12.5vw] sm:h-[10vw] md:h-[6vw] lg:h-[3.5vw] mx-[1vw] md:mx-[0.5vw] my-[2vw] md:my-[1vw] lg:my-[0.7vw] ${props.theme === "dark" ? "border border-solid border-lightblue bg-lightblue" : "bg-darkblue"}`;
