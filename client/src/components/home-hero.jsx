    ...
    return (
        <div className="h-[65vh] sm:h-[75vh] flex items-start sm:items-center">
            ...
            <div className="text-center md:text-left w-[90vw] sm:w-[80vw] md:w-[60vw] lg:w-[45vw] h-[50%] m-auto md:ml-[10vw] mt-[10vw]">
                ...
                <div className="text-lightblue text-[10vw] sm:text-[7vw] md:text-[4vw] lg:text-[3vw] font-bold leading-tight">
                ...
                <div>
                    <p className="text-dullblue text-[5vw] sm:text-[3.5vw] md:text-[2vw] lg:text-[1.5vw] leading-tight mt-[3%]">
